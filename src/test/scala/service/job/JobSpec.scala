...
class JobSpec extends UnitSpec {
  ...
  lazy private[job] val trk1ar = SpotifyAlbumTrackRef("t1", "song1", 1)
  ...
  lazy private[job] val trk1fld = trk1fd.copy(lyrics = "song1lyrics")
  ...
  lazy private[job] val trk2ar = SpotifyAlbumTrackRef("t2", "song2", 2)
  ...
  lazy private[job] val trk2fld = trk2fd.copy(lyrics = "song2lyrics")
  ...
  lazy private[job] val trk3ar = SpotifyAlbumTrackRef("t3", "song3", 1)
  ...
  lazy private[job] val trk4ar = SpotifyAlbumTrackRef("t4", "song4", 1)
  lazy private[job] val trk4f = SpotifyAudioFeatures("t4", liveness = 2.1f)
  lazy private[job] val trk4fd = trk4d.copy(features = trk4f.toMap)
  ...
  lazy private[job] val alb1r = SpotifyAlbumRef("alb1", "album1")
  ...
  lazy private[job] val alb2r = SpotifyAlbumRef("alb2", "album2")
  ...
  lazy private[job] val alb3r = SpotifyAlbumRef("alb3", "album3")
